...
const TourFormEdit = ({ handleHide, handleFetch, data}) => {
     ...
     useEffect(() => {
          ...
          reset({
               ...
               group: data.group,
               price: data.price,
               serv_insurance: services.insurance,
               serv_food: services.food,
               serv_transport: services.transport,
               serv_accommodation: services.accommodation,
          });
     },[])
     ...
     const onSubmit = async (data) => {
          ...
          await api.put("api/admin/tour/update/" + tourID, merged);
